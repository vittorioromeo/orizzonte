...
namespace orizzonte::thread_pool::third_party
{
    /// @brief The fixed_function<R(ARGS...), storage_size> class implements
    /// functional object.
    /// @details This function is analog of 'std::function' with limited
    /// capabilities:
    ...
    public:
        ...
        {
            ORIZZONTE_ASSERT(_method_ptr != nullptr);
