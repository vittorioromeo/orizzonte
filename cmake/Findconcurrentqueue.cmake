...
find_path(
    ...
    DOC "Include directory for the concurrentqueue library"
    ...
    PATHS
        ...
        /opt/csw/
        /opt/
        "${PROJECT_SOURCE_DIR}/extlibs/concurrentqueue/"
        "${CMAKE_CURRENT_LIST_DIR}/../../"

        NO_DEFAULT_PATH
)

if (NOT EXISTS "${CONCURRENTQUEUE_INCLUDE_DIR}" AND DEFINED CONCURRENTQUEUE_CLONE_DIR)
    set(_build_dir "${CMAKE_CURRENT_BINARY_DIR}/concurrentqueue")

    if (DEFINED CONCURRENTQUEUE_ENABLE_TESTS)
    ...
    ExternalProject_Add(concurrentqueue
        ...
        # Configure step
        SOURCE_DIR "${CONCURRENTQUEUE_CLONE_DIR}"
    ...
    set(CONCURRENTQUEUE_INCLUDE_DIR "${CONCURRENTQUEUE_CLONE_DIR}/include")
endif()

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(CONCURRENTQUEUE DEFAULT_MSG CONCURRENTQUEUE_INCLUDE_DIR)
